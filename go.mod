...
replace gitlab.torproject.org/tpo/anti-censorship/pluggable-transports/snowflake/v2 => gitlab.torproject.org/WofWca/snowflake/v2 v2.3.2-0.20250121171518-88d0eb0d693d
